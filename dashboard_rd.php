    ...
    font-size: 13px;
                    ...
                    <div class="table-responsive">
                        <table class="table axil-product-table axil-cart-table mb--40">
                            <thead>
                                 <tr>
                                    <th><small style="font-size:15px;"><?php echo 'Product Name' ?></small></th>
                                    <th><small style="font-size:15px;">Image</small></th>
                                    <th><small style="font-size:15px;">Downloads</small></th>
                                    <th><small style="font-size:15px;">Date</small></th>
                                    
                                </tr>
                            </thead>
                            <tbody><?php
                                            $i=0;
                                            $statement1 = $pdo->prepare("SELECT * FROM tbl_downloads WHERE customer_email='".$_SESSION['customer']['cust_email']."' AND paid =1");
                                            $statement1->execute();
                                        ...
                                        <td data-title="Product Name: "><?php $row1['product_name']; ?></td>
                                        <td ><img style="width:70px;height:70px;" src="./assets/uploads/<?php echo $row1['product_image']; ?>"></td>
                                        <td ><br><a href="./assets/uploads/<?php echo $row1['download_path']; ?>"><b style="color:orange;">
                                            Click here to access this product!</b></a></td>
