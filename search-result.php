            ...
            ?>
                    ...
                    <div class="axil-product-list">
                        ...
                        <div class="product-content">
                            ...
                            <!--</span>-->
                                <span class="rating-number"><span><?=$tot_rating?>+</span> Reviews</span>
                            </div>
                            <h6 class="product-title"><a href="single-product.html"><?php echo $row['p_name']; ?></a></h6>
                            <div class="product-price-variant">
                                <span class="price current-price">$<?php echo $row['p_current_price']; ?></span>
                                <?php if($row['p_old_price'] != ''): ?>
                                                <span class="price old-price">$<?php echo $row['p_old_price']; ?></span>
                                                <?php endif; ?>
                            ...
                            <div class="product-cart">
                                 <?php else: ?>
                                <a href="product.php?id=<?php echo $row['p_id']; ?>" class="cart-btn"><i class="fal fa-shopping-cart"></i></a>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
...
?>      <!-- End Footer Area  -->
    ...
    <div class="header-search-modal" id="header-search-modal">
        ...
        <div class="header-search-wrap">
            ...
            <div class="card-body">
                <div class="search-result-header">
                    <!--<h6 class="title"> Result Found</h6>-->
