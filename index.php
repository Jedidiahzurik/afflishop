...
<![endif]-->
    <a href="?explore=true#top" class="back-to-top" id="backto-top"><i class="fal fa-arrow-up"></i></a>
    <!-- Start Header -->
<?php
            ...
            ?>
                                    <div class="single-slide slick-slide">
                                        <div class="main-slider-content">
                                            ...
                                            <div class="shop-btn">
                                                <a href="?explore=true#explore" class="axil-btn">Shop Now <i class="fal fa-long-arrow-right"></i></a>
                                            </div>
                                        </div>
                            ...
                            <div class="slider-product-box">
                                <div class="product-thumb">
                                    <a href="registration.php">
                                        <img src="assets/images/logo/logo.png" alt="l">
                                    <!--<img src="assets/images/product/product-41.png" alt="Product">-->

                                    </a>
                                </div>
                                <h6 class=""><sup>Become an afliate earn amazing commisions. Or become a vendor and get your products sales pushed by professional affiliates</sup></h6>
                                <span class="price"><em>Afflishop</em></span>
                            </div>
                        </div>
                    </div>
                </div>
...
-->
                ...
                <div class="row">
                    <div class="col-lg-12 text-center mt--20 mt_sm--0">
                        <a href="?explore=true#explore" class="axil-btn btn-bg-lighter btn-load-more">View More Products</a>
                    </div>
                </div>
