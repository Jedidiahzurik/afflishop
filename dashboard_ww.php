                    ...
                    <div class="table-responsive">
                        <table class="table axil-product-table axil-cart-table mb--40">
                            <thead>
                               <tr>
                            <th scope="col"> # </th>
                            <th scope="col" class="product-thumbnail">Purpose</th>
...
$error_message = '';
    ...
    $i = 0;
    $f_total_aff_earn = 0;
    $statement = $pdo->prepare("SELECT * FROM tbl_unv_pay WHERE email ='".$_SESSION['customer']['cust_email']."'");
    $statement->execute();
    $result = $statement->fetchAll(PDO::FETCH_ASSOC);
    foreach ($result as $row) {
      $i++;
?>     
                        ...
                        ?>>
                            <td data-title="#"><?=$i?></td>
                            <td class="product-subtotal" data-title="Purpose">
                                <?=$row['purpose']?>
                            ...
                            <td class="product-subtotal" data-title="Status"><?php if($row['status']){
                            ...
                            <td class="product-price" data-title="Address">
                            <?php  if(isset($row['wallet'])){echo substr($row['wallet'],0,5)."...".substr($row['wallet'],-3,-3);} ?>
                            </td>
